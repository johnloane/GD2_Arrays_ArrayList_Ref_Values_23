...
public class Main
{
    /* The purpose of this application is to help a company called Dawood's Hamburgers to manage selling hamburgers.
    It will help Dawood to select types of burgers, some additional items and pricing
    We want a base hamburger, but also two other types
    The basic hamburger should have the following items:
    bun type, meat, and up to 4 additional items (lettuce, tomatoe, etc) that the customer can select to add to the burger
    Each one of the additions gets charged an additional price, so you need some eway to track how many additional items have been added so you can work out the price
    This burger has a base price and additions are all separately priced
